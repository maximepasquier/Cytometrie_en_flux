...
public:
  ...
  void set(const QVector<DataType> &data, bool *gated_data_array, bool alreadySorted = false);
  void add(const QCPDataContainer<DataType> &data);
  void add(const QVector<DataType> &data, bool alreadySorted = false);
  void add(const QVector<DataType> &data, bool *gated_data_array, bool alreadySorted = false);
...
template <class DataType>
void QCPDataContainer<DataType>::set(const QVector<DataType> &data, bool *gated_data_array, bool alreadySorted)
{
  mData = data;
  mPreallocSize = 0;
  mPreallocIteration = 0;
...
template <class DataType>
void QCPDataContainer<DataType>::add(const QVector<DataType> &data, bool *gated_data_array, bool alreadySorted)
{
  if (data.isEmpty())
    return;
  if (isEmpty())
  {
    set(data, gated_data_array, alreadySorted);
    return;
  }
...
public:
  ...
  */
  ...
  void setData(const QVector<double> &keys, const QVector<double> &values, bool *gated_data_array, bool alreadySorted = false);
  ...
  void addData(const QVector<double> &keys, const QVector<double> &values, bool *gated_data_array, bool alreadySorted = false);
  void addData(double key, double value);
  void addData(double key, double value, bool *gated_data_array);
...
protected:
  ...
  virtual void getOptimizedScatterData(QVector<QCPGraphData> *scatterData, QCPGraphDataContainer::const_iterator begin, QCPGraphDataContainer::const_iterator end, bool *gated_data_array, std::vector<int> *sampled_gated_data_index_array) const;
